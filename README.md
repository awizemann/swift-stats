...
> still missing is a shipping **backend**: `StatsCloudflare` is a scaffold, so
> today you supply your own `StatsSink`. See [Roadmap](#roadmap).
...
| P12c | `backends/cloudflare/`: ingest Worker on D1 + read helper | in progress |
